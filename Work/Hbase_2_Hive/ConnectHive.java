...
import java.sql.DriverManager;
	...
	public static void main(String[] args) throws SQLException {
		...
		// run as
		Connection con = DriverManager.getConnection("jdbc:hive2://slave3.bigdata.labs:10000/subash", "root", "");
		Statement stmt = con.createStatement();
		String tableName = "dummy2";
		// show tables
	...
	public void dropTable (Statement stmt, String tableName) throws Exception{
